...
class DocsHomeLayout extends PageLayoutBase {
                      ...
                      div(classes: 'docs-home-features-grid', [
                        for (final feature in features)
                          article(classes: 'docs-home-feature-card', [
                            ...
                            if (feature.link case final link?)
                              a(
                                href: link,
                                classes: 'docs-home-feature-link',
            ...
            if (_asNonEmptyString(map['title']) case final title?)
              if (_asNonEmptyString(map['details']) case final details?)
                _DocsHomeFeature(
                  ...
                  title: title,
                  details: details,
                  link: _asNonEmptyString(map['link']),
                ),
      ];
    }
  ...
  static List<StyleRule> get _styles => [
    ...
    css('.docs-home-feature-link').styles(
      display: Display.inlineFlex,
      alignItems: AlignItems.center,
      margin: Margin.only(top: 0.8.rem),
    ...
    css('.docs-home-feature-link:hover').styles(
